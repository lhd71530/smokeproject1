...
class VideoTransformer(VideoTransformerBase):
    ...
    def transform(self, frame):
        ...
        draw.text((int(xmin), int(ymin) - 20), CLASSES[label],
                  (rgb_colors[label][2], rgb_colors[label][1], rgb_colors[label][0]), font=font)
...
if prediction_mode == 'Single image':
    ...
    if uploaded_file is not None:
        ...
        #скопируем реFзультаты работы кэшируемой функции, чтобы не изменить кэш
